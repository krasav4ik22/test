...
public class CSPServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) {
        ...
        log.info(SecurityMarkers.CONFIDENTIAL, "User {} with password {} logged in",name);
        log.info(SecurityMarkers.EVENT_FAILURE, "User {} with password {} logged in", name);
        log.info(SecurityMarkers.EVENT_SUCCESS, "User {} with password {} logged in", name);
        log.info(SecurityMarkers.RESTRICTED, "User {} with password {} logged in", name);
        log.info(SecurityMarkers.SECRET, "User {} with password {} logged in", name);
        log.info(SecurityMarkers.SECURITY_AUDIT, "User {} with password {} logged in", name);
        log.info(SecurityMarkers.SECURITY_FAILURE, "User {} with password {} logged in", name);
        log.info(SecurityMarkers.SECURITY_SUCCESS, "User {} with password {} logged in", name);
        log.info(SecurityMarkers.TOP_SECRET, "User {} with password {} logged in", name);
